            ...
            <Container className="shrink-0">
              <div className="max-w-4xl mx-auto text-center space-y-4">
                ...
                <p className="text-sm md:text-base text-[#4A515E] max-w-2xl mx-auto leading-relaxed">
                  <span className="font-heading font-black">The platform</span> maintains a large collection of books accessed by students, researchers, scholars, government officers and citizens — but current operations face critical bottlenecks.
                </p>
              </div>
            </Container>
        ...
        <Container>
          <div className="space-y-4 text-left mb-10">
            ...
            <p className="text-xs sm:text-sm text-[#4A515E] leading-relaxed">
              The platform maintains a large collection of books accessed by students, researchers, scholars, government officers and citizens — but current operations face critical bottlenecks.
            </p>
          </div>
